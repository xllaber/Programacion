...
public class MatrizBoolean3b {
    public static void main(String[] args) {
        ...
        boolean[][] matrix2 = {{false, false, false, false, true}, {false, false, false, true, true}, {false, false,  true, false, true}, {false, true, false, false, true}, {true, false, false, false, true}, {false, false, false, false, true},{false, false, false, false, true}, {false, false, false, false, true}};
        ...
        System.out.println();
        for (boolean[] elementRow : matrix2) {
            for (boolean elementCol : elementRow) {
                if (elementCol) {
                   System.out.print("0");
                }else{
